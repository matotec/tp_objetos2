...
//@Test 
//public void subscribirseAEncuestaConRespuesta() {
//	this.unInvestigador.subscribirseAEncuestaConRespuesta(this.mockedProyecto, this.mockedEncuesta, this.mockedPregunta, this.mockedRespuesta);
//	verify(mockedEncuesta, times(1)).recibirSubscripcion(unInvestigador, this.mockedProyecto, mockedPregunta, mockedRespuesta);;
//}
