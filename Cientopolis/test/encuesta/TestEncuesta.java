...
//		LocalTime ahora = LocalTime.now();
		...
		assertTrue(fechaCreacion.equals(nuevaFecha));
//		assertFalse(encuesta.getDateCreacion().equals(new Date()));
//		assertEquals(encuesta.getDateCreacion().getDate(), new Date().getDate());
	}
